"""
Django settings for CustomXperienceHubProject project.
...
SECRET_KEY = 'e1g91#umn(tb#d^(*zwu*_@tsess%g6xss$(-p-hrtfn($9+ld'
...
ROOT_URLCONF = 'CustomXperienceHubProject.urls'
...
WSGI_APPLICATION = 'CustomXperienceHubProject.wsgi.application'
